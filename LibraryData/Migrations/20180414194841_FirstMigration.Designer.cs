...
namespace LibraryData.Migrations
{
    ...
    [Migration("20180414194841_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.Customer", b =>
                {
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.CustomerType", b =>
                {
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.MediaType", b =>
                {
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.Section", b =>
                {
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.Users", b =>
                {
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.UserType", b =>
                {
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.Customer", b =>
                {
                    b.HasOne("LibraryData.LIBDBModels.Users", "CustomerNavigation")
                        .WithOne("Customer")
                        .HasForeignKey("LibraryData.LIBDBModels.Customer", "CustomerId")
                        .HasConstraintName("Users_to_Customer");

                    b.HasOne("LibraryData.LIBDBModels.CustomerType", "CustomerTypeNavigation")
                        .WithMany("Customer")
            ...
            modelBuilder.Entity("LibraryData.LIBDBModels.Media", b =>
                {
                    b.HasOne("LibraryData.LIBDBModels.MediaType", "MediaNavigation")
                        .WithOne("Media")
                        .HasForeignKey("LibraryData.LIBDBModels.Media", "MediaId")
                        .HasConstraintName("Type_of_Media");
                });

            modelBuilder.Entity("LibraryData.LIBDBModels.Users", b =>
                {
                    b.HasOne("LibraryData.LIBDBModels.UserType", "UserTypeNavigation")
                        .WithMany("Users")
